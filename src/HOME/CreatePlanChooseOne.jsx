...
export default function CreatePlanChooseOne() {
  return (
    <div className=' mt-[250px] mb-[159px]'>

      <div className="w-full  bg-[#282F38] rounded-[10px] py-[121px] h-[653px] px-6 max-w-7xl m-auto pl-[85px]">
        ...
        <div className="max-w-6xl -auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div>
            ...
            <h2 className="text-[32px] text-[#FEFCF7] font-extrabold mt-3" style={{fontFamily: 'Fraunces'}}>Pick your <br/> coffee</h2>
            <p className=" mt-3 text-white/50 leading-relaxed line-clamp-5">
          ...
          <div>
            ...
            <h2 className="text-[32px] text-[#FEFCF7] font-extrabold mt-3" style={{fontFamily: 'Fraunces'}}>Choose the <br/> frequency</h2>
            <p className=" mt-3 text-white/50 leading-relaxed line-clamp-5">
          ...
          <div>
            ...
            <h2 className="text-[32px] text-[#FEFCF7] font-extrabold mt-3" style={{fontFamily: 'Fraunces'}}>Receive and <br/> enjoy!</h2>
            <p className=" mt-3 text-white/50 leading-relaxed line-clamp-5">
